    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        ...
        <div class="container">
            ...
            <a class="navbar-brand me-2" href="{{ route('admin.dashboard') }}">
                <img src="https://asset.tix.id/wp-content/uploads/2021/10/TIXID_logo_blue-300x82.png" height="25"
                    alt="MDB Logo" style="margin-top: -1px;" />
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarButtonsExample">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    @if (Auth::check() && Auth::user()->role == 'admin')
                        {{-- jika sudah login (check) dan jika menjadi admin --}}
                        <li class="nav-item">
                    ...
                    @elseif (Auth::check() && Auth::user()->role == 'staff')
                        <li class="nav-item">
                            <a href="{{ route('staff.schedules.index') }}" class="nav-link">Jadwal Tiket</a>
                        </li>
                        <li class="nav-item">
